# notes.md — ARCHIVE (older handoff entries)

Older entries moved verbatim from notes.md to keep the gate-read journal to ~3 sessions. Newest-first in notes.md; this archive is chronological (oldest first), same as the original order.
